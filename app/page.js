  ...
  return (
    <>
      ...
      <div
        ...
        style={{
          backgroundImage: "url('/uaebgimg.jpg')", // Path to the image in the public folder
        }}
      ...
      >
        <div className="relative flex flex-col lg:flex-row items-center justify-between p-10 gap-10 min-h-screen">
          ...
          >
            <motion.h1
              className="font-semibold uppercase leading-tight bg-gradient-to-r from-white to-black text-transparent bg-clip-text text-3xl sm:text-4xl md:text-5xl lg:text-[3.50rem] mt-12 sm:mt-12"

              style={{ fontFamily: "Times New Roman, serif" }} 
              variants={titleVariants}
            >
              Migrate to UAE with Golden Visa
            </motion.h1>
            <motion.p
              className="flex text-transparent bg-clip-text bg-gradient-to-r from-white to-white tracking-tight text-left md:font-medium max-w-xl lg:max-w-lg mt-6"
